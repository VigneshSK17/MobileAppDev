...
/// AppointmentJson data for calendar.
///
...
///  DataSource(List<AppointmentJson> source) {
///    appointments = source;
///  }
/// }
///
/// DataSource _getCalendarDataSource() {
///    List<AppointmentJson> appointments = <AppointmentJson>[];
///    appointments.add(
///        AppointmentJson(
...
/// }
///  ```
class AppointmentJson with Diagnosticable {
  ...
  /// The start time for an [AppointmentJson] in [SfCalendar].
  ///
  ...
  /// The end time for an [AppointmentJson] in [SfCalendar].
  ///
  /// Defaults to `DateTime.now()`.
  ///
  /// _Note:_ If this property set with the time prior to the [startTime], then
  /// the [AppointmentJson] will render with half hour time period from the
  /// [startTime].
  ///
  ...
  /// Displays the [AppointmentJson] on the all day panel area of time slot views in
  /// [SfCalendar].
  ///
  /// An [AppointmentJson] rendered between the given [startTime] and [endTime]
  ...
  /// The subject for the [AppointmentJson] in [SfCalendar].
  ///
  ...
  /// The color that fills the background of the [AppointmentJson] view in
  /// [SfCalendar].
  ///
  ...
  /// The start time zone for an [AppointmentJson] in [SfCalendar].
  ///
  ...
  /// The end time zone for an [AppointmentJson] in [SfCalendar].
  ///
  ...
  /// Recurs the [AppointmentJson] on [SfCalendar].
  ///
  /// An [AppointmentJson] will render the one appointment view for the given
  ...
  ///
  /// An [AppointmentJson] with [recurrenceRule] will recur on all the possible
  ...
  /// Defines the notes for an [AppointmentJson] in [SfCalendar].
  ///
  /// Allow to store additional information about the [AppointmentJson] and can be
  /// obtained through the [AppointmentJson] object.
  ///
  /// Defaults to null.
  ///
  /// See also:
  ...
  /// Defines the location for an [AppointmentJson] in [SfCalendar].
  ///
  /// Allow to store location information about the [AppointmentJson] and can be
  /// obtained through the [AppointmentJson] object.
  ///
  /// Defaults to null.
  ///
  ...
  /// The ids of the [CalendarResource] that shares this [AppointmentJson].
  ///
  ...
  /// Defines the recurrence id for an [AppointmentJson] in [SfCalendar],
  ...
  ///
  /// ```dart
  ///AppointmentJsonDataSource _getDataSource() {
  ///  List<AppointmentJson> appointments = <AppointmentJson>[];
  ///  final DateTime exceptionDate = DateTime(2021, 04, 20);
  ///
  ///  final AppointmentJson recurrenceAppointmentJson = AppointmentJson(
  ...
  ///  );
  ///  appointments.add(recurrenceAppointmentJson);
  ///
  ///  final AppointmentJson exceptionAppointmentJson = AppointmentJson(
  ///      startTime: exceptionDate.add(Duration(hours: 10)),
  ///      endTime: exceptionDate.add(Duration(hours: 12)),
  ///      subject: 'Meeting',
  ///      id: '02',
  ///      recurrenceId: recurrenceAppointmentJson.id);
  ///
  ///  appointments.add(exceptionAppointmentJson);
  ///
  ///  return AppointmentJsonDataSource(appointments);
  /// }
  ///
  /// ```
  Object? recurrenceId;

  /// Defines the id for an [AppointmentJson] in [SfCalendar].
  ///
  ...
  /// This is read-only.
  ///
  /// Defines the appointment type for the [AppointmentJson].
  ///
  /// Also refer:
  ...
  /// Here we used isOccurrenceAppointmentJson keyword to identify the
  ...
  AppointmentType _getAppointmentType() {
    if (recurrenceId != null) {
      ...
      if (notes != null && notes!.contains('isOccurrenceAppointmentJson')) {
        notes = notes!.replaceAll('isOccurrenceAppointmentJson', '');
  ...
  bool operator ==(dynamic other) {
    ...
    late final AppointmentJson otherStyle;
    if (other is AppointmentJson) {
      otherStyle = other;
    }
  ...
  // Custom methods
  AppointmentJson.fromLunchMenuJson(Map<String, dynamic> json)
    : startTime = json['startTime'],
      endTime = json['endTime'],
      subject = json['menuItem'],
      color = Color(json['color']),
      isAllDay = true;

  Map<String, dynamic> toLunchMenuJson() => {
